					...
					<div class=" row">
						<div class = 'col-md-4'>
							<div class="input-group">
								...
								<input type="text" class="form-control"  name="lastName" required aria-describe value=<?php echo $_POST['lName'] ?>>
							</div>
						</div>
						<div class = 'col-md-4'>	
								<div class="input-group">
								<span class="input-group-addon">First Name</span>
								<input type="text" class="form-control"  name="firstName" required aria-describe value=<?php echo $_POST['fName'] ?>>
							</div>
						</div>
					</div>
				<div class="row">
				...
				<div class="row">
					...
					<div class = 'col-md-4'>
						<div class="input-group">
							...
							<input name="phoneNum" type="text" class="form-control" required aria-describe placeHolder="(###)###-####" value=<?php echo $_POST['phoneNum'] ?>>
						</div>
					</div>
